...
var $u = (function () {
  ...
  function JRTarget(isSubtableTarget, target) {
    ...
    this.isSubtableTarget = isSubtableTarget;
  ...
  function createJRTarget(strTarget) {
    return (target.indexOf(".") > -1) ?
    new JRTarget(true, "Doe", 50, "blue") :
    new JRTarget(false, "Doe", 50, "blue")
  }
